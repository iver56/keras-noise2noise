...
# Install packages required for installing miniconda 3
...
# First copy only environment.yml, gefolki and keras-retinanet, to cache dependencies
COPY environment.yml ./
RUN conda env create
RUN echo "source activate keras-noise2noise" >> ~/.bashrc
